...
<head>
    ...
    <!--Conexion para la tipografia de google-->
...
<body class="solitreo-regular">

<!--Menu de navegación junto con la ventana emergente-->
    <header>
        <!--Menu de navegación-->
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active" style="width:8vw;">
                        <a class="nav-link nav1 fw-bold navbar-link" href="#">Registrar <i class="fa-solid fa-pen-clip"></i> <span class="sr-only">(current)</span></a>
                    </li>
        
                    <li class="nav-item" style="width:8.2vw;">
                        <a class="nav-link nav2 fw-bold navbar-link" href="#consultar">Consultar <i class="fa-solid fa-magnifying-glass"></i> </a>
                    </li>
        
                    <li class="nav-item" style="width:6.3vw;">
                        <a class="nav-link nav3 fw-bold navbar-link" href="#tablas">Tablas <i class="fa-solid fa-table-list"></i> </a>
                    </li>
        
                    <li class="nav-item" style="width:11.5vw;">
                        <a class="nav-link nav4 fw-bold navbar-link" href="{{ route('descargar.datos4') }}">Descargar BDD <i class="fa-solid fa-download"></i> </a>
                    </li>
        ...
        <!--Ventana Emergente que da la bienvenida y bloquea el acceso a las funciones-->
            ...
            <div class="container">
                ...
                <!--Campos de consulta del formulario con los datos del trabajador -->
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="input3">Lugar de expedición:</label>
